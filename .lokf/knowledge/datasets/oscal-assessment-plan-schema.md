...
version: "1.2.1"
resource: https://github.com/lmodel/oscal/blob/main/src/oscal/schema/oscal_assessment_plan.yaml
...
The **OSCAL Assessment Plan schema** (`src/oscal/schema/oscal_assessment_plan.yaml`) encodes the OSCAL AP model: a document describing the planned approach for assessing a system's security controls.
